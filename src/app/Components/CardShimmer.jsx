...
import '../assets/scss/shimmer.scss'
...
function CardShimmer() {
  ...
  return (
    ...
    //     <div className={"shimmer bg-gray-200 m-4 shadow-lg hover:shadow-xl relative w-[18rem] h-[25rem]"} tabIndex='0'>
    //         <div className="shimmer bg-gray-300 w-1/6 p-3 h-16 flex flex-col absolute items-center">
    //         </div>
    //         <div className="shimmer content-container px-3 py-5 absolute -bottom-6 w-full bg-gray-300">
    //             <div className="card-header flex flex-wrap justify-start mb-3">
    //                 {/* <p className="text-xs">Joe Dane</p>
    //             <p className='text-xs'>+</p> */}
    //                 <p className='w-3 h-2'></p>
    //                 <p className='w-3 h-2'></p>
    //                 <p className='w-3 h-2'></p>
    //             </div>
    //             <div className="heading-container">
    //                 <h1 className='text-2xl font-extralight mb-5 w-full h-3'></h1>
    //             </div>
